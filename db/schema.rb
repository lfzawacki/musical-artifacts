...
ActiveRecord::Schema.define(version: 20260618000000) do
  ...
  add_index "licenses", ["free"], name: "index_licenses_on_free", using: :btree
  ...
  add_index "taggings", ["taggable_type", "context", "tag_id"], name: "index_taggings_on_type_context_tag_id", using: :btree
